...
namespace Rating.Migrations
{
    ...
    [Migration("20210625020839_AlterProductTable_AddTables_RemoveProductTemplateTable")]
    partial class AlterProductTable_AddTables_RemoveProductTemplateTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rating.Comment.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rating.MarketPlace.MarketPlace", b =>
                {
                    ...
                    b.Property<int>("AverageVisitorsCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rating.ProductCategory.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rating.ProductProductFeature.ProductProductFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Rating.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Rating.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Rating.Product.Product", b =>
                {
                    b.HasOne("Rating.MarketPlace.MarketPlace", "MarketPlace")
                        .WithMany()
                        .HasForeignKey("MarketPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rating.ProductCategory.ProductCategory", "ProductCategory")
                        .WithMany()
                        .HasForeignKey("ProductCategId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rating.Supplier.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("Rating.ProductProductFeature.ProductProductFeature", b =>
                {
                    b.HasOne("Rating.ProductFeature.ProductFeature", "Feature")
                        .WithMany("Product")
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rating.Product.Product", "Book")
                        .WithMany("Features")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
